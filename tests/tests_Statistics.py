...
class TestCompute(unittest.TestCase):
    ...
    def test_standard_deviation(self):
        self.assertAlmostEqual(standard_dev(self.s), np.std(self.s), places=6)

    def test_variance(self):
        self.assertAlmostEqual(variance(self.s), np.var(self.s), places=6)

    def test_median(self):
        self.assertAlmostEqual(median(self.s), np.median(self.s), places=6)
